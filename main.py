...
df_factors = pd.read_csv("Input/sp500_factors.csv")
df_factors = df_factors.drop(columns=["Investment (Asset Growth)"])
...
ptf = FractilePortfolio(df_universe=df_factors, target_factor="Low Vol")
df_ptf, ptf_sensi = ptf.process_ptf(save=True)
